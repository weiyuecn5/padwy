...
def index(request):
    if request.method == 'POST':
        ...
        if bh_1 and bh_2 and bh_3 and bh_4 and bh_5 and bh_6:
            shujus=shujuku.objects.filter(已卖__exact='否').filter(宠物__icontains=bh_1).filter(宠物__icontains=bh_2).filter(宠物__icontains=bh_3).filter(宠物__icontains=bh_4).filter(宠物__icontains=bh_5).filter(宠物__icontains=bh_6).exclude(账号编号__icontains='W').exclude(账号编号__icontains='X').exclude(账号编号__icontains='Y')
            for shuju in shujus:
            ...
            shujus=shujuku.objects.filter(已卖__exact='否').filter(宠物__icontains=bh_1).filter(宠物__icontains=bh_2).filter(宠物__icontains=bh_3).filter(宠物__icontains=bh_4).filter(宠物__icontains=bh_5).exclude(账号编号__icontains='W').exclude(账号编号__icontains='X').exclude(账号编号__icontains='Y')
            for shuju in shujus:
                if shuju.宠物.count(bh_1)>=int(cwysl) and shuju.宠物.count(bh_2)>=int(cwesl):
                    jg.append({"bh": shuju.账号编号, "st": shuju.石头数量,"sx":shuju.买家})
            context['shujus'] = jg
            ...
            shujus=shujuku.objects.filter(已卖__exact='否').filter(宠物__icontains=bh_1).filter(宠物__icontains=bh_2).filter(宠物__icontains=bh_3).filter(宠物__icontains=bh_4).exclude(账号编号__icontains='W').exclude(账号编号__icontains='X').exclude(账号编号__icontains='Y')
            for shuju in shujus:
                if shuju.宠物.count(bh_1)>=int(cwysl) and shuju.宠物.count(bh_2)>=int(cwesl):
                    jg.append({"bh": shuju.账号编号, "st": shuju.石头数量,"sx":shuju.买家})
            context['shujus'] = jg
            ...
            shujus=shujuku.objects.filter(已卖__exact='否').filter(宠物__icontains=bh_1).filter(宠物__icontains=bh_2).filter(宠物__icontains=bh_3).exclude(账号编号__icontains='W').exclude(账号编号__icontains='X').exclude(账号编号__icontains='Y')
            for shuju in shujus:
                if shuju.宠物.count(bh_1)>=int(cwysl) and shuju.宠物.count(bh_2)>=int(cwesl):
                    jg.append({"bh": shuju.账号编号, "st": shuju.石头数量,"sx":shuju.买家})
            context['shujus'] = jg
            ...
            shujus=shujuku.objects.filter(已卖__exact='否').filter(宠物__icontains=bh_1).filter(宠物__icontains=bh_2).exclude(账号编号__icontains='W').exclude(账号编号__icontains='X').exclude(账号编号__icontains='Y')
            for shuju in shujus:
                if shuju.宠物.count(bh_1) >= int(cwysl) and shuju.宠物.count(bh_2)>=int(cwesl):
                    jg.append({"bh": shuju.账号编号, "st": shuju.石头数量,"sx":shuju.买家})
            context['shujus'] = jg
            ...
            shujus=shujuku.objects.filter(已卖__exact='否').filter(宠物__icontains=bh_1).exclude(账号编号__icontains='W').exclude(账号编号__icontains='X').exclude(账号编号__icontains='Y')
            for shuju in shujus:
